...
namespace BabyCiao.Controllers
{
    public class NannyResumesController : Controller
    {
        ...
        {
            var nannyResumes = from nn in _context.NannyResumes
                               join ui in _context.UserInformations on nn.NannyAccountUserAccount equals ui.AccountUser into uiGroup
                               ...
                               select new NannyResumeDTO
                               {
                                   ...
                                   DisplayControl = (bool)nn.DisplayControl,
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var resumeDetail = await (from nd in _context.NannyResumes
                                      where nd.Id == id
                                      select new NannyResumeDTO
                                      {
                                          id = nd.Id,
