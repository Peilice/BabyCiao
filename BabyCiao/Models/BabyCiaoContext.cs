...
namespace BabyCiao.Models
{
    public partial class BabyCiaoContext : DbContext
    {
        ...
        public virtual DbSet<SecondHandSupplies> SecondHandSupplies { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExchangeOrder>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasColumnName("ID");
                entity.Property(e => e.AccountA_UserAccount)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                    .HasColumnName("AccountA_UserAccount");
                entity.Property(e => e.AccountB_UserAccount)
                    .HasMaxLength(50)
                    .IsUnicode(false)
                ...
                entity.HasOne(d => d.AccountA).WithMany(p => p.ExchangeOrdersA)
                    .HasPrincipalKey(p => p.Account)
                    .HasForeignKey(d => d.AccountA_UserAccount)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ExchangeOrder_AccountA");

                entity.HasOne(d => d.AccountB).WithMany(p => p.ExchangeOrdersB)
                    .HasPrincipalKey(p => p.Account)
                    .HasForeignKey(d => d.AccountB_UserAccount)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_ExchangeOrder_AccountB");
            });
            ...
            modelBuilder.Entity<SecondHandSupplies>(entity =>
            {
