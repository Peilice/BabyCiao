...
var connectionString = builder.Configuration.GetConnectionString("Babyciao") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
